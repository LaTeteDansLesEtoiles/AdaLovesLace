...
class FileUtilTest {
  ...
  void check_for_a_loaded_dot_lace_file() {
    ...
    // Then
    assertEquals(22, diagramToCheck.getCurrentStepIndex());
    assertEquals(22, diagramToCheck.getPatterns().size());
    assertEquals(SNOWFLAKE_IMAGE, diagramToCheck.getPatterns().get(21).getFilename());

    assertEquals(23, diagramToCheck.getAllSteps().size());
    assertEquals(3, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().size());
    assertEquals(SNOWFLAKE_IMAGE, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().get(0).getPattern().getFilename());
    assertEquals(SNOWFLAKE_IMAGE, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().get(1).getPattern().getFilename());
    assertEquals(SNOWFLAKE_IMAGE, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().get(2).getPattern().getFilename());

    assertEquals(2, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().get(1).getZoomFactor());
    assertEquals(70, diagramToCheck.getAllSteps().get(22).getDisplayedKnots().stream().toList().get(2).getRotationAngle());
  }
